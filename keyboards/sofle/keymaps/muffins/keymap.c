 ...
 * |      |   A  |   S  |   D  |   F  |   G  |-------.    ,-------|   H  |   J  |   K  |   L  |   ;  |  '       |
 * |------+------+------+------+------+------| Next  |    | Stop  |------+------+------+------+------+----------|
 * |LShift|   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  | Ctl+Cmd+Q|
 * `-----------------------------------------/       /     \      \---------------------------------------------'
 *            | LCTR | LAlt | MO(1)| LGUI | /Del    /       \Enter \  |Space |   =  |  [   |   ]  |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'            '------''---------------------------'
 */
...
[0] = LAYOUT(
  ...
  KC_LCTRL, KC_Z,    KC_X,    KC_C,     KC_V,  KC_B, KC_MNXT,           KC_MSTP,   KC_N,   KC_M,    KC_COMM,  KC_DOT,  KC_SLSH, LCTL(LGUI(KC_Q)),
            KC_LCTRL,  KC_LALT,  MO(1), KC_LGUI, KC_DEL,          KC_ENT, KC_SPC,   KC_EQL,  KC_LBRC, KC_RBRC
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[1] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                       KC_HOME,  KC_END,   _______, _______,  _______, KC_F12,
