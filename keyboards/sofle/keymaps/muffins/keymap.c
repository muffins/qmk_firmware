 ...
 * |-------+-------+-------+------+------+------|                    |------+------+------+------+------+------|
 * |       |RGB_TOG|RGBmode|      | PgDwn| PgUp |                    | Prev | Play | Next |      |      | F12  |
 * |-------+-------+-------+------+------+------|                    |------+------+------+------+------+------|
 * |       | hue+  | sat+  | bri+ | Home | End  |-------.    ,-------| Left | Down |  Up  |Right |      |      |
 * |-------+-------+-------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |       | hue-  | sat-  | bri- |      |      |-------|    |-------|   -  |  `   |      |      |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |      |      |      |      | /       /       \      \  |      |      |      |      |
...
[_MOD] = LAYOUT(
  ...
  _______, RGB_TOG, RGB_MOD, _______, KC_PGDN,   KC_PGUP,                       KC_MPRV, KC_MPLY, KC_MNXT,   _______,  _______, KC_F12,
  _______, RGB_HUI, RGB_SAI, RGB_VAI, KC_HOME,   KC_END,                        KC_LEFT,  KC_DOWN,  KC_UP,   KC_RIGHT, _______, _______,
  _______, RGB_HUD, RGB_SAD, RGB_VAD, _______,   _______, _______,     _______, KC_MINUS, KC_GRAVE, _______, _______,  _______, _______,
